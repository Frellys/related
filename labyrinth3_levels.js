let levels = [
    ...
    // lvl: 6
    {
        ...
        field: [
            ['C', '5', 'C', 'B', 'A', 'B', 'A', 'B', '0', 'B', 'A', 'B', 'A', 'B', '8'],
            ['D', '8', 'D', 'A', 'B', '8', '7', 'A', '9', 'C', 'B', 'A', '5', 'C', '9'],
            ['C', '9', 'C', 'B', 'A', '1', '8', '7', '8', 'D', 'A', 'B', 'A', '1', '8'],
            ['D', '0', '9', 'C', 'B', 'A', '9', 'C', '9', 'C', 'B', 'A', 'B', 'A', '9'],
            ['C', '9', 'C', '9', 'C', 'B', '8', 'D', 'A', '1', '0', 'B', '8', '7', '8'],
            ['3', 'C', '9', 'C', '9', 'C', '1', 'A', '5', 'C', '9', '2', 'D', '0', '9'],
            ['C', '9', '6', '1', '4', 'D', 'A', 'B', '8', 'D', '0', '9', '2', 'D', '8'],
            ['D', 'A', 'B', 'A', 'B', 'A', 'B', '4', 'D', 'A', '1', '4', 'D', 'A', '9']
        ]
    },
    // lvl: 7
    {
        ...
        field: [
            ['C', 'B', 'A', 'B', '8', '7', '0', 'B', 'A', 'B', '8', '7', 'A', 'B', '8'],
            ['D', '8', '7', '8', 'D', 'A', '9', 'C', 'B', '4', 'D', '0', 'B', 'A', '9'],
            ['C', '1', '4', 'D', 'A', 'B', '0', '1', 'A', 'B', '8', 'D', '0', 'B', '8'],
            ['3', 'C', 'B', '0', 'B', 'A', '9', 'C', 'B', '8', 'D', '8', 'D', '8', '3'],
            ['2', 'D', '8', 'D', 'A', 'B', '8', 'D', '8', 'D', '8', 'D', '8', 'D', '8'],
            ['D', '0', '9', 'C', 'B', '8', 'D', 'A', '9', '2', 'D', '8', 'D', '0', '9'],
            ['2', 'D', 'A', '9', 'C', '9', 'C', 'B', 'A', '9', 'C', '9', '6', '1', '8'],
            ['D', 'A', 'B', 'A', '1', 'A', '9', '6', 'B', 'A', '9', '6', 'B', 'A', '9']
        ]
    },
    // lvl: 8
    {
        ...
        field: [
            ['C', 'B', 'A', '5', 'C', 'B', 'A', 'B', '8', '7', 'A', 'B', '8', '7', '8'],
            ['D', 'A', 'B', 'A', '1', 'A', 'B', '8', 'D', '0', '5', 'C', '9', 'C', '9'],
            ['C', 'B', '0', 'B', '0', '5', 'C', '9', '6', '1', '0', '1', 'A', '1', '8'],
            ['3', 'C', '9', 'C', '9', 'C', '1', 'A', 'B', '8', '3', 'C', '5', 'C', '9'],
            ['2', 'D', '8', 'D', 'A', '1', 'A', '5', 'C', '9', 'C', '1', '8', 'D', '8'],
            ['D', '0', '1', 'A', 'B', 'A', '5', 'C', '9', '6', '1', '8', 'D', 'A', '9'],
            ['C', '9', 'C', 'B', 'A', 'B', '8', 'D', 'A', 'B', '8', 'D', '8', '7', '8'],
            ['D', 'A', '9', '6', 'B', 'A', '9', '6', 'B', 'A', '1', '4', 'D', 'A', '9']
        ]
    },
    // lvl: 9
    {
        ...
        field: [
            ['C', 'B', '8', '7', '0', 'B', '8', '7', '0', 'B', 'A', 'B', 'A', 'B', '8'],
            ['D', '8', 'D', 'A', '9', '2', 'D', 'A', '9', 'C', '5', 'C', 'B', 'A', '9'],
            ['C', '1', 'A', 'B', 'A', '9', 'C', 'B', '8', 'D', 'A', '9', 'C', 'B', '8'],
            ['D', '8', '7', '0', 'B', '8', 'D', '8', 'D', '0', 'B', 'A', '1', '8', '3'],
            ['C', '9', 'C', '9', 'C', '1', '8', '3', 'C', '9', '6', 'B', '8', 'D', '8'],
            ['D', '0', '9', '2', 'D', '8', 'D', 'A', '9', '6', 'B', 'A', '1', 'A', '9'],
            ['2', 'D', '0', '9', 'C', '1', 'A', 'B', 'A', 'B', '0', 'B', 'A', 'B', '8'],
            ['D', 'A', '9', '6', '1', 'A', '5', '6', 'B', 'A', '9', '6', 'B', 'A', '9']
        ]
    },
    // lvl: next
    {
